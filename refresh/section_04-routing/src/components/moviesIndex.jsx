...
import BootstrapPagination from "../common/components/pagination";
import ListGroup from "../common/components/listGroup";
import BootstrapTable from "../common/components/bootstrap-table/table";
import createCell from "../common/components/bootstrap-table/utils";
...
class MoviesIndex extends Component {
	...
	handleEvent = (col, element) => {
		if (col.key !== "actions") {
			this.props.navigate(`/movies/${element.id.value}`, {
				state: {
					movie: element,
				},
			});
					...
					<section className="col-8">
						{dataSource.length ? (
							<BootstrapTable
								...
								propKey={"genre"}
								propValue={"name"}
								onEventEmitter={this.handleEvent}
